...
export const CallCenter = ({ isMobile = true }: CallCenterProps) => (
  <Typography.Link
    ...
    className={`border-midnightBlue/10 duration-200 ${isMobile ? 'w-95 flexCenter fixed bottom-4 bg-cyan-500 md:hidden' : 'md:flexCenter hidden'} gap-2 rounded-3xl border-2 p-2 hover:border-blue-900 hover:text-white`}
    isTextWhite
    target="_blank"
  >
    <div
